            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.ads.store') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="type" name="type" class="form-control" required>
                                    ...
                                    <option value="{{ $type->id }}" {{ $type->id == old('type') ? "selected" : null }}>
                        ...
                        <div class="form-group row">
                            <label for="image"
                                class="col-md-4 col-form-label text-md-right">{{ __('site.images') }}</label>
                            <div class="col-md-6">
                                <input name="images[]" type="file" class="form-control-file" id="adImages"
